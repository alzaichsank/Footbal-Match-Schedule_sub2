...
import alzaichsank.com.aplikasifootbalmatchschedule.view.Match.`interface`.match_interface
...
class match_presenter(private val view: MatchView) : match_interface {
    ...
    override fun getPrevMatch(context: Activity, id: String, callback: ServerCallback) {
        ...
        async(contextProvider.main) {
            bg {
                mApiService.geteventspastleague(id)
